  ...
  return (
    <div>
      <div className="flex justify-center space-x-2 m-3">
        <button className="bg-blue-300 rounded-lg p-2 font-bold border border-black hover:scale-110 transition transform duration-300">
          ALL GENRE
        </button>
        <button className="bg-gray-400 rounded-lg p-2 font-bold border border-black hover:scale-110 transition transform duration-300">
          ACTION
        </button>
        <button className="bg-gray-400 rounded-lg p-2 font-bold border border-black hover:scale-110 transition transform duration-300">
          ROMANCE
